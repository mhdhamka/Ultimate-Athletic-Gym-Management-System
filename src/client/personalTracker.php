...
<html lang="en">
  ...
  <head>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="dashboard.php.#features">Why Us</a></li>
                            <li class="scroll-to-section"><a href="dashboard.php.#program">Program</a></li>
                            <li class="scroll-to-section"><a href="dashboard.php.#service">Services</a></li>
                            <li class="scroll-to-section"><a href="dashboard.php.#facilities">Facilities </a></li>
                            <li class="scroll-to-section"><a href="dashboard.php.#trainers">About us</a></li>
                            <li class="scroll-to-section"><a href="dashboard.php.#contact-us">Contact Us</a></li> 
    ...
    <article id='tabs-1'>
        ...
        <?php
          $sql="SELECT DISTINCT program FROM progression WHERE clientID = '{$_SESSION['clientID']}'";
        ...
        <?php
          $sql1="SELECT * FROM progression WHERE clientID = '{$_SESSION['clientID']}' ORDER BY sessionNo LIMIT 10";
    ...
    <!-- ***** Progress Tracker Start ***** -->
                  <article id='tabs-2'>
                    ...
                    $query="SELECT DISTINCT sessionNo,sessionDate FROM progresstracker WHERE clientID = '{$_SESSION['clientID']}' ORDER BY sessionNo DESC"; 
                    ...
                    echo "</h6>";
                      ...
                      
                      {
                        ...
                        if($stmt = $conn->prepare("SELECT * FROM progresstracker WHERE sessionNo=? AND clientID = '{$_SESSION['clientID']}'" )){
