        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="../admin/dashboard.php" class="nav-item nav-link active"><i class="fa fa-user-tag me-2"></i>Membership</a>
                    ...
                    <a href="../admin/profile.php" class="nav-item nav-link"><i class="fa fa-user-cog me-2"></i>My Profile</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="bg-secondary text-center rounded p-4">
					...
					<div class="bg-secondary rounded h-100 p-4">
						<form method = "POST" action = "updateMember.php?updateID=<?php echo $updateID ?>">
							...
							<button><a href="../admin/dashboard.php">Cancel</a></button>
