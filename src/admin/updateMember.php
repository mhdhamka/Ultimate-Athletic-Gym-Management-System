<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$sql = "UPDATE membership
				SET date = '$date', expiryDate = '$expdate', membershipStatus = '$status'
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="indexAdmin.php" class="nav-item nav-link active"><i class="fa fa-user-tag me-2"></i>Membership</a>
					<a href="updateWebsite.php" class="nav-item nav-link"><i class="fa fa-laptop me-2"></i>Update Website</a>
                    <a href="manageMember.php" class="nav-item nav-link active"><i class="fa fa-user-plus me-2"></i>Manage Member</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
						<h6 class="mb-0">Update Membership Details</h6>
                    </div>
						<?php
							global $conn;
							$updateID = $_GET['updateID'];
							$sql = "SELECT * FROM membership WHERE membershipID = $updateID";
							$result = mysqli_query($conn, $sql);
					...
					<div class="bg-secondary rounded h-100 p-4">
						<form method = "POST" action = "updateMember.php?updateID=<?php echo $updateID ?>">
							 <div class="row mb-3">
								<label for="inputID" class="col-sm-2 col-form-label">Membership ID</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputInvoice" name = "membershipID" value = "<?php echo $updateID ?>" readonly>
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputInvoice" class="col-sm-2 col-form-label">Full Name</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputInvoice" name = "fname" value = "<?php echo $name ?>" readonly>
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputName" class="col-sm-2 col-form-label">Registration Date</label>
								<div class="col-sm-10">
									<input type="date" class="form-control" id="inputName" name = "date" value = "<?php echo $date ?>">
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputDate" class="col-sm-2 col-form-label">Expiry Date</label>
								<div class="col-sm-10">
									<input type="date" class="form-control" id="inputDate" name = "expdate" value = "<?php echo $expdate ?>">
								</div>
							</div>
							 <div class="row mb-3">
								<label for="inputDate2" class="col-sm-2 col-form-label">Membership Status</label>
								<div class="col-sm-10">
							...
							<button><a href="indexAdmin.php">Cancel</a></button>
							<button type="submit" class="button5" name = "submit">Update</button>
					  </form>
                    </div>
                </div>
            </div>
