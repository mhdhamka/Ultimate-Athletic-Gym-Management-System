        ...
        <div class="content">
			...
			<div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Update Website</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
									<th scope="col">Website Info</th>
                            ...
                            <tbody>
								<tr style = 'text-align: center;'>
									<td>Programs</td>
									<td><button><a href="updateProgram.php?editID=1">Update</a></button></td>
								 </tr>
								 <tr style = 'text-align: center;'>
									<td>Services</td>
									<td><button><a href="updateService.php?editID=1">Update</a></button></td>
								 </tr>
								 <tr style = 'text-align: center;'>
									<td>Facilities</td>
									<td><button><a href="updateFacility.php?editID=1">Update</a></button></td>
								 </tr>
								 <tr style = 'text-align: center;'>
									<td>About Us</td>
									<td><button><a href="updateAboutUs.php?editID=1">Update</a></button></td>
								 </tr>
								 <tr style = 'text-align: center;'>
									<td>Contact Us</td>
									<td><button><a href="updateContactUs.php?editID=1">Update</a></button></td>
								 </tr>
                            </tbody>
                        </table>
                    </div>
