<?php
	...
	if (isset($_POST['submit']))
	{
		...
		{
			$sql = "UPDATE aboutus
			SET staffName = '$name', staffPosition = '$position', staffDetails = '$details'
			WHERE staffID = '$staffID'";
			mysqli_query($conn, $sql);
			
			if (mysqli_query($conn, $sql))
			{   
				header('location: updateAboutUs.php?editID=1');
			}
			else
			{
		...
		else
		{
			...
			$sql = "UPDATE aboutus
			SET staffName = '$name', staffPosition = '$position', staffDetails = '$details', staffIMG = '$path'
			WHERE staffID = '$staffID'";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="../admin/updateWebsite.php" class="nav-item nav-link active"><i class="fa fa-laptop me-2"></i>Update Website</a>
            ...
            <div class="container-fluid pt-4 px-4">
				<div class="bg-secondary text-center rounded p-4">
						<div class="d-flex align-items-center justify-content-between mb-4">
								<h6 class="mb-4">ABOUT US UPDATE</h6>
						</div>
										...
										if ($result -> num_rows > 0)
										{
											while ($row = $result -> fetch_assoc())
											{
												echo "<tr style = 'text-align: left;'>
														...
														<td>".$row['staffDetails']."</td>
														<td><img src = ".$row['staffIMG']." style = 'width: 100%'></td>
														<td>
															<button><a href=\"updateAboutUs.php?editID=$row[staffID]\">Update</a></button>
														</td>
													 </tr>";
											}
										}
					...
					<div class="row g-4">
						<div class="col-sm-12 col-xl-6">
							<div class="bg-secondary rounded h-100 p-4">
								<form action = "updateAboutUs.php" method = "POST"  enctype="multipart/form-data">
									<?php
										global $conn;
										$editID = $_GET['editID'];
										$sql = "SELECT * FROM aboutus WHERE staffID = $editID";
										...
										if ($result -> num_rows > 0)
										{
											while ($row = $result -> fetch_assoc())
											{
												...
												$details = $row['staffDetails'];
											}
										}		
									?>
									<div class="row mb-3">
										<label for="inputFname" class="col-sm-2 col-form-label">Staff ID</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="inputFname" name = "staffID" value = "<?php echo $staffID ?>" readonly>
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputFname" class="col-sm-2 col-form-label">Staff Name</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="inputFname" name = "name" value = "<?php echo $name ?>">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputFname" class="col-sm-2 col-form-label">Staff Position</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="inputFname" name = "position" value = "<?php echo $position ?>">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputFname" class="col-sm-2 col-form-label">Staff Details</label>
										<div class="col-sm-10">
									...
									<button type="submit" class="btn btn-primary" style = "background-color: white"><a href = "../admin/updateWebsite.php" style = "font-color: white;">Cancel</a></button>
