				...
				<div class="bg-secondary text-center rounded p-4">
					...
					<table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
								<?php
									global $conn;
									$sql = "SELECT * FROM customer WHERE programJoined = 'Eek! Personal Program' OR programJoined ='Eek! Online Program'";
									$result = mysqli_query($conn, $sql);
									...
									if ($result -> num_rows > 0)
									{
										while ($row = $result -> fetch_assoc())
										{
											echo "<tr style = 'text-align: center;'>
													...
													<td>
														<button><a href=\"viewprogress.php?viewID=$row[customerID]\">View</a></button>
														<button><a href=\"updateprogress.php?updateID=$row[customerID]\">Update</a></button>
													</td>
												 </tr>";
										}
									}
