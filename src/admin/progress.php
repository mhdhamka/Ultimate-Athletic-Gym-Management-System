<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$sql = "SELECT * FROM progresssession WHERE membershipID = '$membershipID'";
				...
				<div class="bg-secondary text-center rounded p-4">
					...
					<table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
								<?php
									global $conn;
									$sql = "SELECT * FROM client WHERE programJoined = 'Eek! Personal Program' OR programJoined ='Eek! Online Program'";
									$result = mysqli_query($conn, $sql);
									...
									if ($result -> num_rows > 0)
									{
										while ($row = $result -> fetch_assoc())
										{
											echo "<tr style = 'text-align: center;'>
													...
													<td>
														<button><a href=\"../admin/viewprogress.php?viewID=$row[clientID]\">View</a></button>
														<button><a href=\"../admin/updateprogress.php?updateID=$row[clientID]\">Update</a></button>
													</td>
												 </tr>";
										}
									}
