<?php
	session_start();
	include ("../src/config/db_cUAGMS.php");
	...
	if (isset($_POST['submit']))
	{
		...
		if ($program == '')
		{
			...
			{   
				$sql = "DELETE FROM progresssession
					WHERE customerID = '$customerID'";
               ...
               <div class="bg-secondary text-center rounded p-4">
                            ...
                            <tbody>
								<?php
									...
									if ($result -> num_rows > 0)
									{
										while ($row = $result -> fetch_assoc())
										{
											echo "<form method = 'POST' action = 'registerMember.php?regID=$row[customerID]'>
					...
					<div class="bg-secondary rounded h-100 p-4">
						<form method = "POST" action = "registerMember.php">
							...
							<button><a href="manageMember.php">Cancel</a></button>
