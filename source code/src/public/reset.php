...
if (isset($_POST['submit'])) {
    ...
    // Check Admin
    $sql = "SELECT adminPassword FROM admin WHERE adminEmail='$email'";
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        echo "<script>
                alert('Admin Password: ".$row['adminPassword']."');
                window.location='../public/loginAdmin.php';
              </script>";
        exit();
    }
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        echo "<script>
                alert('Client Password: ".$row['password']."');
                window.location='../public/loginClient.php';
              </script>";
        exit();
    }
...
<head>
    <meta charset="utf-8">
    <title>Ultimate Athletics Gym Management</title>
